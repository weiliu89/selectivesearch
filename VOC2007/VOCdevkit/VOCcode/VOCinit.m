...
VOCopts.year = 2007;
VOCopts.dataset=sprintf('VOC%d', VOCopts.year);
...
VOCopts.datadir=[HOMEDIR '/data/pascal/'];
...
% change this path to a writable directory or your jobs
VOCopts.jobdir=[VOCopts.datadir VOCopts.projname '/jobs/' VOCopts.dataset '/'];
if ~exist(VOCopts.jobdir, 'dir')
	mkdir(VOCopts.jobdir);
end
...
VOCopts.featpath=[VOCopts.datadir VOCopts.dataset '/Features/%s.mat'];
