function [feats, labels, boxes, ids] = wl_getSSFeat(bbsInfo)
% wl_getSSFeat() will get the information of the bounding box
%
% Input:
...
for iImg = 1:nImgs
    ...
    pyramids = [1 3];
    [beta goodIdx] = LLC_pooling_mex_sparse(a.s.x, a.s.y, a.s.scales, a.llc_codes, bbs(idx, [2 1 4 3]), pyramids);
